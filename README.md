...
三种阅读格式（EPUB / TXT / XTC）均支持安全版翻页动画。

**开启方式**：设置 -> 阅读 -> 翻页动画 -> 卷轴 / 百叶窗

| 模式 | 效果 |
|---|---|
| 关闭 | 现有全刷（默认） |
| 卷轴 Scroll | 条带自上而下逐个揭开新页 |
| 百叶窗 Blinds | 偶数条带先揭开，再揭开奇数条带 |

**速度**：5 档（很慢 / 慢 / 正常 / 快 / 很快），对应 8 / 6 / 4 / 2 / 1 条带。

**中断**：动画进行中按任意键立即停止，并做一次半刷清残影。
